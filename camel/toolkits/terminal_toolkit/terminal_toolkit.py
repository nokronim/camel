...
class TerminalToolkit(BaseToolkit):
    ...
    def shell_exec(self, id: str, command: str, block: bool = True, timeout: Optional[float] = None) -> str:
        r"""
        ...
        Args:
            ...
            timeout (Optional[float]): The maximum time in seconds to wait for the command to complete when block=True.
                If None, uses the default timeout set during toolkit initialization (20 seconds).
                Maximum allowed value is 60 seconds. Only applies to blocking mode.
            ...
            try:
                if not self.use_docker_backend:
                    ...
                    result = subprocess.run(
                        ...
                        timeout=timeout, cwd=self.working_dir, encoding="utf-8"
                    )
                    ...
                    # 2. Wait for the thread to finish, up to timeout
                    # If timeout is None, this waits indefinitely (standard behavior)
